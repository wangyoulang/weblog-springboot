<template>
    ...
    <div class="grid grid-cols-2 h-screen">
        ...
        <div class="col-span-2 order-2 p-10 md:col-span-1 md:order-1 bg-slate-900">
            ...
            <div class="flex justify-center items-center h-full flex-col animate__animated animate__bounceInLeft animate_fast">
                ...
                <!-- 指定图片宽度为父级元素的 1/2 -->
                <img src="@/assets/登录图片.png" class="w-1/2">
            </div>
        </div>
        <div class="col-span-2 order-1 md:col-span-1 md:order-2 bg-white">
        	<!-- flex-col 用于指定子元素垂直排列 -->
            <div class="flex justify-center items-center h-full flex-col animate__animated animate__bounceInRight animate_fast">
                <!-- 大标题，设置字体粗细、大小、下边距 -->
